...
const generateTsAbis_1 = __importDefault(require("./scripts/generateTsAbis"));
...
(0, config_1.task)("deploy").setAction(async (args, hre, runSuper) => {
    // Run the original deploy task
    await runSuper(args);
    // Force run the generateTsAbis script
    await (0, generateTsAbis_1.default)(hre);
});
