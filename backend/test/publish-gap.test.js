...
describe('the command that paints it', () => {
    ...
    it('asks for the ground first, exactly as publish does', () => {
        ...
        expect(src).toContain("await CadastralParcelRepository.ensureProposalGround([record], { purpose: 'publish' })");
        expect(src.indexOf("await CadastralParcelRepository.ensureProposalGround([record], { purpose: 'publish' })"))
