    ...
    async function fetchOwnershipDetails(parcelId, options = {}) {
        ...
        const requestPromise = (async () => {
            try {
                ...
                const url = `${getOssOwnershipEndpoint()}?parcel=${encodeURIComponent(normalizedParcelId)}&cadastralParcelId=${encodeURIComponent(normalizedParcelId)}`;
